    ...
    var body: some View {
        List {
            Section("licenses_section_attributions".localized) {
                LicenseRow(
                    iconName: "3d_star_progradient",
                    attribution: "Decoration PNGs by Vecteezy",
                    url: "https://www.vecteezy.com/png/48386636-a-five-pointed-star-3d-icon-pink-purple-blue-isolated-on-a-transparent-background"
                )
                 LicenseRow(
                     iconName: "3d_cloud_progradient",
                     attribution: "Cloud Icon PNGs by Vecteezy",
                     url: "https://www.vecteezy.com/png/55445028-elegant-minimalistic-cloud-icon-for-nature-inspired-designs"
                 )
                LicenseRow(
                    iconName: "CardInfo_completion_rate",
                    attribution: "3d List PNGs by Vecteezy",
                    url: "https://www.vecteezy.com/png/54716302-data-visualization-3d-growth-chart-business-analytics-progress-report-statistical-graph-financial-metrics-market-trends-data-analysis-performance-indicators-upward-trend-investment-growth"
                )
                LicenseRow(
                    iconName: "CardInfo_active_days",
                    attribution: "3d Calendar PNGs by Vecteezy",
                    url: "https://www.vecteezy.com/png/56565480-3d-green-checkmark-on-transparent-background"
                )
                LicenseRow(
                    iconName: "CardInfo_habits_done",
                    attribution: "Icon PNGs by Vecteezy",
                    url: "https://www.vecteezy.com/png/56565480-3d-green-checkmark-on-transparent-background"
                )
                LicenseRow(
                    iconName: "CardInfo_active_habits",
