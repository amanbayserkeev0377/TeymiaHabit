    ...
    func makeUIView(context: Context) -> some UIView {
        ...
        DispatchQueue.main.async {
            if let compositingGroup = view.superview?.superview {
                guard let tabHostinController = compositingGroup.subviews.last else { return }
                guard let tabController = tabHostinController.subviews.first?.next as? UITabBarController else { return }
